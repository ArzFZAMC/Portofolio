...
const CONTACTS = [
  {
    id: 'github',
    label: 'GitHub',
    value: 'github.com/ArzFZAMC',
    display: '@ArzFZAMC',
    Icon: FiGithub,
    color: '#e2e8f0',
    href: 'https://github.com/ArzFZAMC',
    copyable: false,
  },
  {
    id: 'instagram',
    label: 'Instagram',
    value: '@rasyaarista24',
    display: '@rasyaarista24',
    Icon: FiInstagram,
    color: '#e1306c',
    href: 'https://www.instagram.com/rasyaarista24/',
    copyable: true,
  },
  {
    id: 'email',
    label: 'Email',
    value: 'fresyajayawardana@gmail.com',
    display: 'fresyajayawardana@gmail.com',
    Icon: FiMail,
    color: '#00d4ff',
    href: 'mailto:fresyajayawardana@gmail.com',
    copyable: true,
  },
  {
    id: 'whatsapp',
    label: 'WhatsApp',
    value: '+62 813-9813-4291',
    display: '+62 813-9813-4291',
    Icon: FiMessageCircle,
    color: '#25d366',
    href: 'https://wa.me/6281398134291',
    copyable: true,
  },
]
